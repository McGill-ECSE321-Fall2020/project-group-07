...
public class OnlineGalleryPersistenceTest {
	...
	public void testPersistingAndLoadingRegistrationAttributesAndAssociations() {
		...
		// also happens to be the only direct association type that GalleryRegistration
		// has: compositions
		...
		Long artistUniqueId = artist.getArtistId(); // get the unique id generated when each object is persisted for
													// comparison later
	...
	public void testPersistingAndLoadingPurchaseAttributesAndAssociations() {
		...
		// boilerplate to propagate the persistence through all the classes that lie
		// upstream
	...
	public void testPersistingAndLoadingProfileAttributesAndAssociations() {
		...
		// getting primary keys of all the objects associated with profile + profile
		// itself
	...
	public void testPersistingAndLoadingShipmentAttributesAndAssociations() {
		...
		// Getting primary keys of all the objects associated with shipment + shipment
		// itself
		Long purchaseId = purchase.getPurchaseId();
		Long shipmentId = shipment.getShipmentId();
		Long ogId = og.getSystemId();
