...
public class TestPurchaseServiceUpdate {
	...
	@Test
	public void testValidShipmentOption1() {
		...
		try {
			p=service.updatePurchaseShipment(dto);
		}
	...
	@Test
	public void testValidShipmentOption2() {
		PurchaseDto dto = new PurchaseDto();
		dto.setUsername(VALID_USERNAME);
		dto.setArtworkId(VALID_ARTWORKID);
		dto.setShipmentType(ShipmentType.ONSITE_PICKUP);
		...
		assertNotNull(p);
		assertEquals(p.getShipmentType(),ShipmentType.ONSITE_PICKUP);
	}	
}
